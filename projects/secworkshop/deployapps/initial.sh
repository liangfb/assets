...
mysql -hwordpress-cluster.cluster-czfoanuhqt04.ap-northeast-1.rds.amazonaws.com -uliangfb -pPassword01 -e "use wordpressdb; update wp_options set option_value='http://$4' where option_name='siteurl' or option_name='home';update wp_posts set post_content = replace(post_content, '54.92.58.70', '$4');"